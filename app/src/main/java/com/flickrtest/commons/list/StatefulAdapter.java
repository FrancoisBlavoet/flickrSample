...
import static com.flickrtest.commons.list.StatefulAdapter.ContentState.CONTENT;

/**
 * Adapter handling different states : loading, empty, content & error.
 */
public abstract class StatefulAdapter extends Adapter<ViewHolder> {
    ...
    public final boolean setCurrentState(ContentState state, boolean notifyIfSame) {
        Log.d(TAG, "setCurrentState() called with: " + "state = [" + state + "], notifyIfSame = [" + notifyIfSame + "]");
